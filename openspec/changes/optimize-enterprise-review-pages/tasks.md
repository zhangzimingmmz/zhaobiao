...
- [x] 6.2 检查构建输出无错误
- [ ] 6.3 重启运营后台容器 (docker-compose restart admin-frontend) - 需在生产服务器执行
- [ ] 6.4 访问生产环境验证部署成功

## 7. 生产环境验证

- [ ] 7.1 访问 https://admin-zhaobiao.zhangziming.cn
- [ ] 7.2 验证菜单名称显示为"审核队列"和"企业管理"
- [ ] 7.3 测试企业管理页面筛选器功能
- [ ] 7.4 验证审核队列页面功能正常
- [ ] 7.5 测试完整的审核工作流（查看、审核、筛选）
